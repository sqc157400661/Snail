...
![Go内存管理](D:\www\Snail\Go专题系列\book\images\2019-07-go-memory-manage.png)
...
![img](D:\www\Snail\Go专题系列\book\images\2019-07-data-heirarchy.jpg)
...
![CPU和内存速率差异](D:\www\Snail\Go专题系列\book\images\2019-07-CPU-DRAM.png)
...
不要以为有了[Cache](https://zh.wikipedia.org/wiki/CPU缓存)就万事大吉了，CPU的速率还在不断增大，Cache也在不断改变，从最初的1级，到后来的2级，到当代的3级Cache，*（有兴趣看cache历史）*。

![MBP的CPU和Cache信息](D:\www\Snail\Go专题系列\book\images\2019-07-mbp-memory.png)
...
![虚拟内存原理](D:\www\Snail\Go专题系列\book\images\2019-07-Virtual-Memory-in-OS-Operating-System.png)
...
![虚拟内存布局](D:\www\Snail\Go专题系列\book\images\2019-07-figure_6-1.png)
...
![内存管理](D:\www\Snail\Go专题系列\book\images\2019-07-Mutator-Allocator-Collector.png)
...
![内存块链表](D:\www\Snail\Go专题系列\book\images\2019-07-Memory_Blocks.png)

一个内存块包含了3类信息，如下图所示，元数据、用户数据和对齐字段，内存对齐是为了提高访问效率。下图申请5Byte内存的时候，就需要进行内存对齐。

![内存块和对齐](D:\www\Snail\Go专题系列\book\images\2019-07-Alignment-Header.png)
...
![TCMalloc概要图](D:\www\Snail\Go专题系列\book\images\2019-07-tcmalloc-Overview.svg)
...
![PageHeap](D:\www\Snail\Go专题系列\book\images\2019-07-tcmalloc-PageHeap.svg)
...
3. [TCMalloc介绍](https://blog.csdn.net/aaronjzhang/article/details/8696212)
...
![Go内存管理](D:\www\Snail\Go专题系列\book\images\2019-07-go-memory-detail.png)
...
![Go内存大小转换](D:\www\Snail\Go专题系列\book\images\2019-07-go-memory-sizes.png)
...
![Go内存分配表](D:\www\Snail\Go专题系列\book\images\2019-07-go-sizetable.png)
...
![Size转换](D:\www\Snail\Go专题系列\book\images\2019-07-size_tranform.png)
...
![Span内object分布情况](D:\www\Snail\Go专题系列\book\images\2019-07-span-objects.png)
...
![Go内存对象分类](D:\www\Snail\Go专题系列\book\images\2019-07-go-memory-classify.png)
...
```
// noscan为true代表对象不包含指针func makeSpanClass(sizeclass uint8, noscan bool) spanClass {	return spanClass(sizeclass<<1) | spanClass(bool2int(noscan))}
```
...
![Span内对象](D:\www\Snail\Go专题系列\book\images\2019-07-go-memory-objs.png)
...
![mcentral](D:\www\Snail\Go专题系列\book\images\2019-07-go-mcentral.png)
...
![mheap](D:\www\Snail\Go专题系列\book\images\2019-07-go-mheap.png)
...
```
// MAC下的实现func sysUnused(v unsafe.Pointer, n uintptr) {	// MADV_FREE_REUSABLE is like MADV_FREE except it also propagates	// accounting information about the process to task_info.	madvise(v, n, _MADV_FREE_REUSABLE)}
```
...
https://lessisbetter.site/2019/07/06/go-memory-allocation/