...
前面说了 map 实现的几种方案，Go 语言采用的是**哈希查找表**，并且**使用链表解决哈希冲突**。
...
![hashmap bmap](D:\www\Snail\Go专题系列\images\57576986-acd87600-749f-11e9-8710-75e423c7efdb.png)



当 map 的 **key 和 value 都不是指针**，并且 size 都**小于 128 字节**的情况下，会把 `bmap` **标记为不含指针**，这样可以**避免 gc 时扫描整个 hmap**。但是，我们看 bmap 其实有一个 overflow 的字段，是指针类型的，破坏了 bmap 不含指针的设想，这时会把 overflow 移动到 extra 字段来。
...
![bmap struct](D:\www\Snail\Go专题系列\images\57577391-f88f1d80-74a7-11e9-893c-4783dc4fb35e.png)
...
![mapacess](D:\www\Snail\Go专题系列\images\57577721-faf57580-74af-11e9-8826-aacdb34a1d2b.png)
...
```
 ...
 是 bmap 的地址，这里 bmap 还是源码里定义的结构体，只包含一个 tophash 数组，经编译器扩充之后的结构体才包含 key，value，overflow 这些字段。dataOffset 是 key 相对于 bmap 起始地址的偏移：
...
![mapacess loop](D:\www\Snail\Go专题系列\images\57581783-fe5c2180-74ee-11e9-99c9-5a226216e1af.png)
