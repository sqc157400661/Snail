...
大家都知道著名的摩尔定律。1965 年，仙童公司的 Gordon Moore 发表文章，预测在未来十年，半导体芯片上的晶体管和电阻数量将每年增加一倍；1975 年，Moore 再次发表论文，将“每年”修改为“每两年”。这个预测在 2012 年左右基本是正确的。
...
![concurrency code decision tree](D:\www\Snail\Go专题系列\images\61507065-e0db9480-aa16-11e9-9fab-2ba43ee90c95.png)
...
```
chan T // 声明一个双向通道chan<- T // 声明一个只能用于发送的通道<-chan T // 声明一个只能用于接收的通道
```
...
![chan data structure](D:\www\Snail\Go专题系列\images\61179068-806ee080-a62d-11e9-818c-16af42025b1b.png)
...
![make chan](D:\www\Snail\Go专题系列\images\61337268-4d179600-a867-11e9-98ac-f979e3da00a6.png)
...
![unbuffered chan](D:\www\Snail\Go专题系列\images\61338760-91a63000-a86d-11e9-9c7e-edee8a594f66.png)
...
![chan struct at the runtime](D:\www\Snail\Go专题系列\images\61179141-19eac200-a62f-11e9-836d-b6b95d52f6fb.png)
...
![recvq structure](D:\www\Snail\Go专题系列\images\61179210-d3966280-a630-11e9-8c73-5a22340910a6.png)
...
![chan state](D:\www\Snail\Go专题系列\images\61340165-bbfaec00-a873-11e9-83de-66bc63e603f1.png)
...
![M:N scheduling](D:\www\Snail\Go专题系列\images\61340362-8c001880-a874-11e9-9237-d97e6105cd62.png)
...
![MGP](D:\www\Snail\Go专题系列\images\61340473-1183c880-a875-11e9-9b3e-86f376d3ae55.png)

继续回到例子。假设我们只有一个 M，当 G1（`go goroutineA(ch)`） 运行到 `val := <- a` 时，它由本来的 running 状态变成了 waiting 状态（调用了 gopark 之后的结果）：

![G1 running](D:\www\Snail\Go专题系列\images\61340756-45abb900-a876-11e9-8ac7-4c40b4c23253.png)

G1 脱离与 M 的关系，但调度器可不会让 M 闲着，所以会接着调度另一个 goroutine 来运行：

![G1 waiting](D:\www\Snail\Go专题系列\images\61340787-67a53b80-a876-11e9-94a4-a6c3698eb8ed.png)
...
![G1 runnable](D:\www\Snail\Go专题系列\images\61342598-4bf16380-a87d-11e9-8667-c22b02030d6b.png)
...
![send direct](D:\www\Snail\Go专题系列\images\61342620-64fa1480-a87d-11e9-8cac-eacd2f4892f8.png)
...
![output](D:\www\Snail\Go专题系列\images\61191276-16ad1000-a6db-11e9-9729-cdea7744f002.png)
...
这里将 toStop 声明成了一个 缓冲型的 channel。假设 toStop 声明的是一个非缓冲型的 channel，那么第一个发送的关闭 dataCh 请求可能会丢失。因为无论是 sender 还是 receiver 都是通过 select 语句来发送请求，如果中间人所在的 goroutine 没有准备好，那 select 语句就不会选中，直接走 default 选项，什么也不做。这样，第一个关闭 dataCh 的请求就会丢失。(这里有疑问)
